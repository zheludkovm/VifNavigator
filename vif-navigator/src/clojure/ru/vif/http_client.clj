...
(def vif-url "http://vif2ne.ru/nvk/forum/0/co/tree")
...
(defn download-message [^String link]
  "Скачивает сообщение"
  (download-html (str vif-message-prefix link))
  )

(defn download-vif-content []
  "Скачивает дерево сообщений целиком"
  (download-html vif-url)
  )
